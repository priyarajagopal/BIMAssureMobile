...
static const INV_ERROR_CODE INV_ERROR_CODE_NOPERMISSIONS = 403;
...
static const INV_ERROR_MESG INV_ERROR_MESG_NOPERMISSIONSFAILURE = @"User does not have permissions to perform this operation";
