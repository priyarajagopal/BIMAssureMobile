...
/**
 Removes all persisted pending invites cached data information pertaining to the signed in user. Although the deletion is
 initated , a nil error response does not necessarily imply that all data was
