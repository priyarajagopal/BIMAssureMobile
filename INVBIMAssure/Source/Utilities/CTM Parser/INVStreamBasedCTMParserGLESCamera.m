...
-(void) loadProgramNamed:(NSString *)programName {
    ...
    INVStreamBasedCTMParserGLESCamera_ProjectionTransformUniformLocation = glGetUniformLocation(_program, "u_projectionTransform");
    INVStreamBasedCTMParserGLESCamera_ModelViewTransformUniformLocation = glGetUniformLocation(_program, "u_modelViewTransform");
