...
-(UIViewController *) primaryViewControllerForCollapsingSplitViewController:(UISplitViewController *)splitViewController {
    ...
    for (id<NSObject, UISplitViewControllerDelegate> delegate in _delegates) {
        if ([delegate respondsToSelector:_cmd]) {
            UIViewController *delegateResults = [delegate primaryViewControllerForCollapsingSplitViewController:splitViewController];
...
-(UIViewController *)primaryViewControllerForExpandingSplitViewController:(UISplitViewController *)splitViewController {
    ...
    for (id<NSObject, UISplitViewControllerDelegate> delegate in _delegates) {
        if ([delegate respondsToSelector:_cmd]) {
            UIViewController *delegateResults = [delegate primaryViewControllerForExpandingSplitViewController:splitViewController];
...
-(UIInterfaceOrientation) splitViewControllerPreferredInterfaceOrientationForPresentation:(UISplitViewController *)splitViewController {
    ...
    for (id<NSObject, UISplitViewControllerDelegate> delegate in _delegates) {
        if ([delegate respondsToSelector:_cmd]) {
            UIInterfaceOrientation delegateResults = [delegate splitViewControllerPreferredInterfaceOrientationForPresentation:splitViewController];
