...
+ (MBProgressHUD *)loginUserHUD:(NSString *)extra
{
    ...
    NSString *mesg = extra ? [NSString stringWithFormat:@"%@ %@", NSLocalizedString(@"LOGGING_IN", nil), extra]
                           : NSLocalizedString(@"LOGGING_IN", nil);
...
+ (MBProgressHUD *)loginAccountHUD:(NSString *)extra
{
    ...
    [hud setAnimationType:MBProgressHUDAnimationFade];
    [hud setMode:MBProgressHUDModeIndeterminate];
    NSString *mesg = extra ? [NSString stringWithFormat:@"%@ %@", NSLocalizedString(@"LOGGING_IN_ACCOUNT", nil), extra]
                           : NSLocalizedString(@"LOGGING_IN_ACCOUNT", nil);
...
+ (MBProgressHUD *)signupHUD:(NSString *)extra
{
    ...
    [hud setAnimationType:MBProgressHUDAnimationFade];
    [hud setMode:MBProgressHUDModeIndeterminate];
    NSString *mesg = extra ? [NSString stringWithFormat:@"%@ %@", NSLocalizedString(@"SIGNING_UP", nil), extra]
                           : NSLocalizedString(@"SIGNING_UP", nil);
...
+ (MBProgressHUD *)loadingViewHUD:(NSString *)extra
{
    ...
    [hud setAnimationType:MBProgressHUDAnimationFade];
    [hud setMode:MBProgressHUDModeIndeterminate];
    NSString *mesg = extra ? [NSString stringWithFormat:@"%@ %@", NSLocalizedString(@"LOADING_DATA", nil), extra]
                           : NSLocalizedString(@"LOADING_DATA", nil);
