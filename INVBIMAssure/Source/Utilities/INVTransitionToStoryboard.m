...
UIStoryboardSegue *segueWithBlock(NSString *identifier, id source, id dst, void (^aBlock)(UIStoryboardSegue *theSegue))
{
    ...
    id results = [UIStoryboardSegue segueWithIdentifier:identifier
                                                 source:source
                                            destination:dst
                                         performHandler:^{
                                             if (aBlock) {
...
- (UIStoryboardSegue *)_createSegueWithDestination:(id)destination
{
    switch (self.transitionType) {
        ...
        case StoryboardTransitionCustom: {
            ...
            return [[segueClass alloc] initWithIdentifier:self.identifier
...
- (void)perform:(id)sender
{
    ...
    UIStoryboard *destinationStoryboard =
        [UIStoryboard storyboardWithName:self.targetStoryboard bundle:[NSBundle bundleForClass:[self class]]];
